...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YlThirdPartyPrequalificationApiClient.AddressModel();
  });
  ...
  describe('AddressModel', function() {
    it('should create an instance of AddressModel', function() {
      ...
      //var instane = new YlThirdPartyPrequalificationApiClient.AddressModel();
      //expect(instance).to.be.a(YlThirdPartyPrequalificationApiClient.AddressModel);
    });
